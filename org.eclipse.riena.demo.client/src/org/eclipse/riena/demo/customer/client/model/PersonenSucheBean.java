...
public class PersonenSucheBean extends AbstractBean {
	...
	// private ArrayList<IPersonenSucheChangeHandler>
	// personenSucheChangedHandler = new
	// ArrayList<IPersonenSucheChangeHandler>();
	...
	private void personenSucheChanged() {
		// for (IPersonenSucheChangeHandler handler :
		// personenSucheChangedHandler) {
