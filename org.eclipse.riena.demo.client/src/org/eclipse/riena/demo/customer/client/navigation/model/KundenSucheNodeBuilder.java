 ...
 *
 */
public class KundenSucheNodeBuilder extends NavigationNodeBuilder {
	...
	public INavigationNode<?> buildNode(NavigationNodeId nodeId, NavigationArgument navigationArgument) {
		...
		IModuleNode module = new ModuleNode(null, "Kundensuche"); //$NON-NLS-1$
		module.setIcon(createIconPath(ExampleIcons.ICON_GREEN_LED));
		moduleGroup.addChild(module);
		ISubModuleNode subModule = new SubModuleNode(new NavigationNodeId("org.eclipse.riena.example.client.kundensuche"), "Suche"); //$NON-NLS-1$ //$NON-NLS-2$
