 ...
 * Wiring currently supports to approaches for wiring:
 * <ul>
 * <li>Wiring by explicitly specifying a class which is responsible for all the
 * wiring needs of a component. This is done with the class annotation {@code
 * WireWith}.</li>
