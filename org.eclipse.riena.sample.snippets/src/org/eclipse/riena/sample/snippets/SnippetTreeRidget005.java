...
public class SnippetTreeRidget005 {
	...
	public SnippetTreeRidget005(Shell shell) {
		...
		WordNodeWithIcon[] roots = createTreeInput();
	...
	private WordNodeWithIcon[] createTreeInput() {
		WordNodeWithIcon root = new WordNodeWithIcon("Alphabet"); //$NON-NLS-1$

		WordNodeWithIcon node1 = new WordNodeWithIcon(root, "A-Z (English)"); //$NON-NLS-1$
		node1.setIcons(SharedImages.IMG_CHECKED, SharedImages.IMG_UNCHECKED);
		WordNodeWithIcon nodeEye = new WordNodeWithIcon(node1, "Eye"); //$NON-NLS-1$
		nodeEye.setIcons(SharedImages.IMG_UNCHECKED, null);
		WordNodeWithIcon nodeBe = new WordNodeWithIcon(node1, "Be"); //$NON-NLS-1$
		...
		WordNodeWithIcon node2 = new WordNodeWithIcon(root, "A-Z (German)"); //$NON-NLS-1$
		...
		WordNodeWithIcon node3 = new WordNodeWithIcon(root, "A-Z (Greek)"); //$NON-NLS-1$
