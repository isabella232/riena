...
public class Snippet004TreeRidget {
	...
	private ITreeNode[] createTreeInput() {
		...
		ITreeNode root = new TreeNode("Gods"); //$NON-NLS-1$

		ITreeNode greek = new TreeNode(root, "Greek Gods"); //$NON-NLS-1$
		...
		ITreeNode germanic = new TreeNode(root, "Germanic Gods"); //$NON-NLS-1$
