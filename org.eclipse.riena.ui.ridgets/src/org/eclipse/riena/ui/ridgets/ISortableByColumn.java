...
public interface ISortableByColumn {
	 ...
	 * 
	 * @param ascending
	 *            <code>true</code> for ascending order, <code>false</code>
	 *            for descending order.
	 */
	public void setSortedAscending(boolean ascending);

	/**
	 * @return the index of the currently sorted column or <code>-1</code> if
	 ...
	 * Turning <em>off</em> the sortability of the currently sorted column
	 * does not change it's sort order.
	 * <p>
