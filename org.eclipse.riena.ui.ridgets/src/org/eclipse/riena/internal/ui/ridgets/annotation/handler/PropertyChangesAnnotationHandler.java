...
import org.eclipse.riena.ui.ridgets.annotation.OnPropertyChanges;
...
/**
 * Annotation handler for {@code OnPropertyChanges}
 * 
 * @since 3.0
 */
public class PropertyChangesAnnotationHandler extends AbstractRidgetContainerAnnotationHandler {
	...
	public void handleAnnotation(final Annotation annotation, final IRidgetContainer ridgetContainer,
		...
		if (annotation instanceof OnPropertyChanges) {
			for (final OnPropertyChange nestedAnnotation : ((OnPropertyChanges) annotation).value()) {
