...
public class SubApplicationBinder {
	...
	public SubApplicationBinder(final ISubApplicationNode subApplicationNode, final IEclipseContext context) {
		this.subApplicationNode = subApplicationNode;
		binding = createBinding();
		//		initUIProcessRidget((Shell) context.get(IServiceConstants.ACTIVE_SHELL));
	...
	private void initUIProcessRidget(final Shell shell) {
