...
/**
 * Tests of the class <code>ModuleNodeViewController</code>.
 */
public class ModuleNodeViewControllerTest extends TestCase {
	...
	public void testAfterBind() throws Exception {
		...
		node.setLabel("Hello");
		ModuleNodeViewController controller = new ModuleNodeViewController(node);
