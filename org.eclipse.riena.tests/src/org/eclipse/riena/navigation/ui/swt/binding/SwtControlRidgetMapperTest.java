...
public class SwtControlRidgetMapperTest extends RienaTestCase {
	...
	/**
	 * <<<<<<< HEAD ======= Tests the method <code>addMapping(Class<? extends Widget> , Class<? extends IRidget> , int )</code> .
	 * 
	 * @throws Exception
	 *             handled by JUnit
	 */
	public void testAddMappingSwtStyle() throws Exception {
		...
		mapper.addMapping(MockComposite.class, MockRidget.class);
		mapper.addMapping(MockComposite.class, MockRidget2.class, new StyleCondition(SWT.BORDER));
	...
	/**
	 * >>>>>>> branch 'master' of local repository Tests the method {@link SwtControlRidgetMapper#addMapping(Class, Class, IMappingCondition)} .
	 */
