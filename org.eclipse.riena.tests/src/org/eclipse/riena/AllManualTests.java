...
/**
 * Tests all ´manual´ test cases within this bundle.
 */
...
public class AllManualTests extends TestCase {
	...
	public static Test suite() {
		return TestCollector.createTestSuiteWithJUnit3And4(Activator.getDefault().getBundle(), null, ManualTestCase.class);
	}
