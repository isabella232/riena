...
public class SelectionProviderMultipleSelectionObservableList extends WritableList {
	 ...
	 * @param elementType
	 */
	public SelectionProviderMultipleSelectionObservableList(Realm realm, ISelectionProvider selectionProvider,
			Object elementType) {
	...
	protected void fireListChange(ListDiff diff) {
		if (handlingSelection) {
			...
			try {
				...
				selectionProvider.setSelection(new StructuredSelection(wrappedList));
