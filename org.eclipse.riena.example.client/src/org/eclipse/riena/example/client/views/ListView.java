...
import org.eclipse.riena.example.client.controllers.ListViewController;
 ...
 */
public class ListView extends SubModuleNodeView<ListViewController> {

	public static final String ID = ListView.class.getName();
	...
	@Override
	protected ListViewController createController(ISubModuleNode subModuleNode) {
		return new ListViewController(subModuleNode);
	}
