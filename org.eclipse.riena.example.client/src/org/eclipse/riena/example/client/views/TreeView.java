...
import org.eclipse.riena.example.client.controllers.TreeViewController;
 ...
 */
public class TreeView extends SubModuleNodeView<TreeViewController> {

	public static final String ID = TreeView.class.getName();
	...
	@Override
	protected TreeViewController createController(ISubModuleNode subModuleNode) {
		return new TreeViewController(subModuleNode);
	}
