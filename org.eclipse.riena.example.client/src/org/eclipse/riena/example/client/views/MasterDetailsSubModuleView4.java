 ...
 */
public class MasterDetailsSubModuleView4 extends SubModuleView {

	public static final String ID = MasterDetailsSubModuleView4.class.getName();
	...
	private Group createMasterDetails(final Composite parent) {
		final Group result = UIControlsFactory.createGroup(parent, "Master/Details that requires at least 5 entries!"); //$NON-NLS-1$
		final FillLayout layout = new FillLayout(SWT.HORIZONTAL);
